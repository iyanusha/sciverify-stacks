...
interface Funding_trackerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP40({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP40Props) {
