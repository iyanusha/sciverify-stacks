...
interface Dataset_viewerP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP71({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP71Props) {
