...
interface Lab_notebookP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP61({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP61Props) {
