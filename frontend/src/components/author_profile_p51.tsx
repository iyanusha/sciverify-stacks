...
interface Author_profileP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP51({ title = 'Add author profile pages', data, onAction }: Author_profileP51Props) {
