...
interface Lab_notebookP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP41({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP41Props) {
