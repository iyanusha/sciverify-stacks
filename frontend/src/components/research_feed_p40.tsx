...
interface Research_feedP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP40({ title = 'Add research activity feed', data, onAction }: Research_feedP40Props) {
