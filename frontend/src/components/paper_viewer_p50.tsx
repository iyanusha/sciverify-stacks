...
interface Paper_viewerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP50({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP50Props) {
