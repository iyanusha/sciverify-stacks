...
interface Metrics_dashP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP30({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP30Props) {
