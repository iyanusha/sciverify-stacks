...
interface Author_profileP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP50({ title = 'Add author profile pages', data, onAction }: Author_profileP50Props) {
