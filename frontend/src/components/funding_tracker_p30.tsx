...
interface Funding_trackerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP30({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP30Props) {
