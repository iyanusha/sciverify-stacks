...
interface Lab_notebookP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP51({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP51Props) {
