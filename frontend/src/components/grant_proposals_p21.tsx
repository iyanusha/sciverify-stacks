...
interface Grant_proposalsP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP21({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP21Props) {
