...
interface Funding_trackerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP20({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP20Props) {
