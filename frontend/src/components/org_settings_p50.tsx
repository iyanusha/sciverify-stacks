...
interface Org_settingsP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP50({ title = 'Add organization settings', data, onAction }: Org_settingsP50Props) {
