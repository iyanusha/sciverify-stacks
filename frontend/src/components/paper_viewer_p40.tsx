...
interface Paper_viewerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP40({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP40Props) {
