...
interface Author_profileP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP20({ title = 'Add author profile pages', data, onAction }: Author_profileP20Props) {
