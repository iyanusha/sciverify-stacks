...
interface Reviewer_boardP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP60({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP60Props) {
