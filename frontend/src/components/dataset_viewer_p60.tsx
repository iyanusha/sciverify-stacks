...
interface Dataset_viewerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP60({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP60Props) {
