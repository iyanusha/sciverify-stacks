...
interface Ethics_reviewP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP40({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP40Props) {
