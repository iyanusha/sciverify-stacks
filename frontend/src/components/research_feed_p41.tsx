...
interface Research_feedP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP41({ title = 'Add research activity feed', data, onAction }: Research_feedP41Props) {
