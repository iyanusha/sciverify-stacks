...
interface Dataset_viewerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP20({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP20Props) {
