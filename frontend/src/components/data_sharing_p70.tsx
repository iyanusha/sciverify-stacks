...
interface Data_sharingP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP70({ title = 'Add data sharing portal', data, onAction }: Data_sharingP70Props) {
