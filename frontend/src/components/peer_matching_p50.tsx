...
interface Peer_matchingP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Peer_matchingP50({ title = 'Add peer reviewer matching', data, onAction }: Peer_matchingP50Props) {
