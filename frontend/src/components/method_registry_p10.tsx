...
interface Method_registryP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP10({ title = 'Add method registry system', data, onAction }: Method_registryP10Props) {
