...
interface Conf_calendarP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP71({ title = 'Add conference calendar', data, onAction }: Conf_calendarP71Props) {
