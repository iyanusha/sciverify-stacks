...
interface Impact_metricsP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP10({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP10Props) {
