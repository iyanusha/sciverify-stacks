...
interface Org_settingsP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP10({ title = 'Add organization settings', data, onAction }: Org_settingsP10Props) {
