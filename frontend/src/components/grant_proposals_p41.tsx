...
interface Grant_proposalsP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP41({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP41Props) {
