...
interface Paper_viewerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP60({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP60Props) {
