...
interface Funding_trackerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP50({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP50Props) {
