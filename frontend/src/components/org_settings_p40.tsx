...
interface Org_settingsP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP40({ title = 'Add organization settings', data, onAction }: Org_settingsP40Props) {
