...
interface Collaboration_toolsP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Collaboration_toolsP20({ title = 'Add collaboration tools', data, onAction }: Collaboration_toolsP20Props) {
