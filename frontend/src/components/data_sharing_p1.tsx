...
interface Data_sharingP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP1({ title = 'Add data sharing portal', data, onAction }: Data_sharingP1Props) {
