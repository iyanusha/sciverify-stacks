...
interface Conf_calendarP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP51({ title = 'Add conference calendar', data, onAction }: Conf_calendarP51Props) {
