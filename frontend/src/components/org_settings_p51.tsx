...
interface Org_settingsP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP51({ title = 'Add organization settings', data, onAction }: Org_settingsP51Props) {
