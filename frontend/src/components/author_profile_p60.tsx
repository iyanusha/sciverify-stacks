...
interface Author_profileP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP60({ title = 'Add author profile pages', data, onAction }: Author_profileP60Props) {
