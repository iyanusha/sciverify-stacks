...
interface Author_profileP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP10({ title = 'Add author profile pages', data, onAction }: Author_profileP10Props) {
