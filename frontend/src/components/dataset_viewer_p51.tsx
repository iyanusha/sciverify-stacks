...
interface Dataset_viewerP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP51({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP51Props) {
