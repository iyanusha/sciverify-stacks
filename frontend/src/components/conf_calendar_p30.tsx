...
interface Conf_calendarP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP30({ title = 'Add conference calendar', data, onAction }: Conf_calendarP30Props) {
