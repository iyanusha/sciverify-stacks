...
interface Reviewer_boardP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP21({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP21Props) {
