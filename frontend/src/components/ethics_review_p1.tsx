...
interface Ethics_reviewP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP1({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP1Props) {
