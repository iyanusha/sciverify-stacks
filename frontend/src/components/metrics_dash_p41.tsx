...
interface Metrics_dashP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP41({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP41Props) {
