...
interface Citation_graphP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Citation_graphP60({ title = 'Add citation graph visualization', data, onAction }: Citation_graphP60Props) {
