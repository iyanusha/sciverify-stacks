...
interface Method_registryP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP31({ title = 'Add method registry system', data, onAction }: Method_registryP31Props) {
