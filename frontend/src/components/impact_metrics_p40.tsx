...
interface Impact_metricsP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP40({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP40Props) {
