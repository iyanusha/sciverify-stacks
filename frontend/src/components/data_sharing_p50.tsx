...
interface Data_sharingP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP50({ title = 'Add data sharing portal', data, onAction }: Data_sharingP50Props) {
