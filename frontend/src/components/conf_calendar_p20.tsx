...
interface Conf_calendarP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP20({ title = 'Add conference calendar', data, onAction }: Conf_calendarP20Props) {
