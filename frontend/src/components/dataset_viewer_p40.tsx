...
interface Dataset_viewerP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP40({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP40Props) {
