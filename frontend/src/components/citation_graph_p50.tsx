...
interface Citation_graphP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Citation_graphP50({ title = 'Add citation graph visualization', data, onAction }: Citation_graphP50Props) {
