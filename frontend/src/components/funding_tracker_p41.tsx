...
interface Funding_trackerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP41({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP41Props) {
