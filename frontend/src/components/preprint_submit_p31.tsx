...
interface Preprint_submitP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP31({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP31Props) {
