...
interface Paper_viewerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP0({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP0Props) {
