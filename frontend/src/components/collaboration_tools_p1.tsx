...
interface Collaboration_toolsP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Collaboration_toolsP1({ title = 'Add collaboration tools', data, onAction }: Collaboration_toolsP1Props) {
