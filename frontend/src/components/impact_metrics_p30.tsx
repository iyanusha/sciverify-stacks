...
interface Impact_metricsP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP30({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP30Props) {
