...
interface Org_settingsP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP20({ title = 'Add organization settings', data, onAction }: Org_settingsP20Props) {
