...
interface Lab_notebookP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP71({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP71Props) {
