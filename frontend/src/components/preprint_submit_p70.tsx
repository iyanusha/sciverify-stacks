...
interface Preprint_submitP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP70({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP70Props) {
