...
interface Grant_proposalsP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP50({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP50Props) {
