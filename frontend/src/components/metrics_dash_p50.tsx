...
interface Metrics_dashP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP50({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP50Props) {
