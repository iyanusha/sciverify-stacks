...
interface Preprint_submitP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP51({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP51Props) {
