...
interface Grant_proposalsP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP1({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP1Props) {
