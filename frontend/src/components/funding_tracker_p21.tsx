...
interface Funding_trackerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP21({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP21Props) {
