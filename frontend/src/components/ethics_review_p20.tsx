...
interface Ethics_reviewP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP20({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP20Props) {
