...
interface Author_profileP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP41({ title = 'Add author profile pages', data, onAction }: Author_profileP41Props) {
