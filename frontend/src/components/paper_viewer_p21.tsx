...
interface Paper_viewerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP21({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP21Props) {
