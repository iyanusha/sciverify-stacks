...
interface Conf_calendarP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP40({ title = 'Add conference calendar', data, onAction }: Conf_calendarP40Props) {
