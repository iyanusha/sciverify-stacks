...
interface Method_registryP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP41({ title = 'Add method registry system', data, onAction }: Method_registryP41Props) {
