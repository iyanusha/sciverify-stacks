...
interface Paper_viewerP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP1({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP1Props) {
