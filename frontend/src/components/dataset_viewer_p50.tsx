...
interface Dataset_viewerP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP50({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP50Props) {
