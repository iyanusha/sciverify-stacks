...
interface Funding_trackerP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP31({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP31Props) {
