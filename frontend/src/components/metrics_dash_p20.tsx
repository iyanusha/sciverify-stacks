...
interface Metrics_dashP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP20({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP20Props) {
