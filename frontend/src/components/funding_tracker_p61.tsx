...
interface Funding_trackerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP61({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP61Props) {
