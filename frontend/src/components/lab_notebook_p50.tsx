...
interface Lab_notebookP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP50({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP50Props) {
