...
interface Reviewer_boardP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP50({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP50Props) {
