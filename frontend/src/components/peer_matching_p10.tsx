...
interface Peer_matchingP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Peer_matchingP10({ title = 'Add peer reviewer matching', data, onAction }: Peer_matchingP10Props) {
