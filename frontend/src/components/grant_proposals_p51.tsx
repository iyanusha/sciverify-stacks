...
interface Grant_proposalsP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP51({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP51Props) {
