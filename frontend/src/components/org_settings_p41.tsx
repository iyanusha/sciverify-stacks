...
interface Org_settingsP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP41({ title = 'Add organization settings', data, onAction }: Org_settingsP41Props) {
