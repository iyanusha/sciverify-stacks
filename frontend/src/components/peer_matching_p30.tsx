...
interface Peer_matchingP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Peer_matchingP30({ title = 'Add peer reviewer matching', data, onAction }: Peer_matchingP30Props) {
