...
interface Data_sharingP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP71({ title = 'Add data sharing portal', data, onAction }: Data_sharingP71Props) {
