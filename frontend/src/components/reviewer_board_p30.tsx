...
interface Reviewer_boardP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP30({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP30Props) {
