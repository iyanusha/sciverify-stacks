...
interface Conf_calendarP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP31({ title = 'Add conference calendar', data, onAction }: Conf_calendarP31Props) {
