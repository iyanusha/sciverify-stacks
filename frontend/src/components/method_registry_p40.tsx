...
interface Method_registryP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP40({ title = 'Add method registry system', data, onAction }: Method_registryP40Props) {
