...
interface Metrics_dashP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP51({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP51Props) {
