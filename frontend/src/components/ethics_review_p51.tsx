...
interface Ethics_reviewP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP51({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP51Props) {
