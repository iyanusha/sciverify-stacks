...
interface Impact_metricsP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP31({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP31Props) {
