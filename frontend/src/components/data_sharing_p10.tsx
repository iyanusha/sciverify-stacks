...
interface Data_sharingP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP10({ title = 'Add data sharing portal', data, onAction }: Data_sharingP10Props) {
