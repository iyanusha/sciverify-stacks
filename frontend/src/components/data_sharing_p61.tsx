...
interface Data_sharingP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP61({ title = 'Add data sharing portal', data, onAction }: Data_sharingP61Props) {
