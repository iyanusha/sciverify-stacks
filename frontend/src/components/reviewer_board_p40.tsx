...
interface Reviewer_boardP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP40({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP40Props) {
