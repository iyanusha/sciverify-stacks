...
interface Method_registryP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP60({ title = 'Add method registry system', data, onAction }: Method_registryP60Props) {
