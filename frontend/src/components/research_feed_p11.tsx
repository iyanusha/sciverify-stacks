...
interface Research_feedP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP11({ title = 'Add research activity feed', data, onAction }: Research_feedP11Props) {
