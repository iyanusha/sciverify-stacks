...
interface Research_feedP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP10({ title = 'Add research activity feed', data, onAction }: Research_feedP10Props) {
