...
interface Ethics_reviewP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP70({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP70Props) {
