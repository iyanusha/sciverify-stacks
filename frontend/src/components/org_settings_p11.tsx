...
interface Org_settingsP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP11({ title = 'Add organization settings', data, onAction }: Org_settingsP11Props) {
