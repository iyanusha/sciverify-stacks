...
interface Preprint_submitP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP21({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP21Props) {
