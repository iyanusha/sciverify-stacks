...
interface Ethics_reviewP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP60({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP60Props) {
