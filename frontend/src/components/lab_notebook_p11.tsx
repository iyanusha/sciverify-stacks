...
interface Lab_notebookP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP11({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP11Props) {
