...
interface Preprint_submitP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP41({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP41Props) {
