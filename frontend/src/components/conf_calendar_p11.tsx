...
interface Conf_calendarP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP11({ title = 'Add conference calendar', data, onAction }: Conf_calendarP11Props) {
