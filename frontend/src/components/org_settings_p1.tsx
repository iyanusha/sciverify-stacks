...
interface Org_settingsP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP1({ title = 'Add organization settings', data, onAction }: Org_settingsP1Props) {
