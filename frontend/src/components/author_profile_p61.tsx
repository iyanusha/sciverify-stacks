...
interface Author_profileP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP61({ title = 'Add author profile pages', data, onAction }: Author_profileP61Props) {
