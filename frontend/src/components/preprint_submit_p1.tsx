...
interface Preprint_submitP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP1({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP1Props) {
