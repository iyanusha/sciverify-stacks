...
interface Method_registryP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP1({ title = 'Add method registry system', data, onAction }: Method_registryP1Props) {
