...
interface Metrics_dashP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP71({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP71Props) {
