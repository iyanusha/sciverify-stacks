...
interface Impact_metricsP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP1({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP1Props) {
