...
interface Grant_proposalsP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP11({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP11Props) {
