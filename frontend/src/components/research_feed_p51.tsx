...
interface Research_feedP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP51({ title = 'Add research activity feed', data, onAction }: Research_feedP51Props) {
