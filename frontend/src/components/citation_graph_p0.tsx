...
interface Citation_graphP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Citation_graphP0({ title = 'Add citation graph visualization', data, onAction }: Citation_graphP0Props) {
