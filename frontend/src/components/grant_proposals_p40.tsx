...
interface Grant_proposalsP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP40({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP40Props) {
