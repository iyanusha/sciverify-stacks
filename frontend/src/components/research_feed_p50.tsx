...
interface Research_feedP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP50({ title = 'Add research activity feed', data, onAction }: Research_feedP50Props) {
