...
interface Grant_proposalsP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP0({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP0Props) {
