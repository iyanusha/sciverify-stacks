...
interface Funding_trackerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP0({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP0Props) {
