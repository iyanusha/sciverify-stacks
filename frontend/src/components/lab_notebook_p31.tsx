...
interface Lab_notebookP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP31({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP31Props) {
