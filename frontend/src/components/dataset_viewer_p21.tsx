...
interface Dataset_viewerP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP21({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP21Props) {
