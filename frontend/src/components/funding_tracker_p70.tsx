...
interface Funding_trackerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP70({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP70Props) {
