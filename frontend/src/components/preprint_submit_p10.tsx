...
interface Preprint_submitP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP10({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP10Props) {
