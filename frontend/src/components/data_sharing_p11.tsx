...
interface Data_sharingP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP11({ title = 'Add data sharing portal', data, onAction }: Data_sharingP11Props) {
