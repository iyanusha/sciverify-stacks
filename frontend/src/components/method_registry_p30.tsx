...
interface Method_registryP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP30({ title = 'Add method registry system', data, onAction }: Method_registryP30Props) {
