...
interface Research_feedP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP1({ title = 'Add research activity feed', data, onAction }: Research_feedP1Props) {
