...
interface Collaboration_toolsP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Collaboration_toolsP40({ title = 'Add collaboration tools', data, onAction }: Collaboration_toolsP40Props) {
