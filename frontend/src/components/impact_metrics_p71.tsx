...
interface Impact_metricsP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP71({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP71Props) {
