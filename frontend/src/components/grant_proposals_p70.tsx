...
interface Grant_proposalsP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP70({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP70Props) {
