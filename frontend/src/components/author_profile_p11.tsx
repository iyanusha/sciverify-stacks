...
interface Author_profileP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP11({ title = 'Add author profile pages', data, onAction }: Author_profileP11Props) {
