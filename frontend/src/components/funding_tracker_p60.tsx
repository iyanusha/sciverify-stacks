...
interface Funding_trackerP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP60({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP60Props) {
