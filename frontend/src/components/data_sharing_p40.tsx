...
interface Data_sharingP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP40({ title = 'Add data sharing portal', data, onAction }: Data_sharingP40Props) {
