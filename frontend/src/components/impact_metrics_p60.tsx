...
interface Impact_metricsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP60({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP60Props) {
