...
interface Conf_calendarP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP0({ title = 'Add conference calendar', data, onAction }: Conf_calendarP0Props) {
