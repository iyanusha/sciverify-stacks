...
interface Metrics_dashP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP1({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP1Props) {
