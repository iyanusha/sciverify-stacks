...
interface Grant_proposalsP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP20({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP20Props) {
