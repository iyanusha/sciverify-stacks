...
interface Author_profileP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP40({ title = 'Add author profile pages', data, onAction }: Author_profileP40Props) {
