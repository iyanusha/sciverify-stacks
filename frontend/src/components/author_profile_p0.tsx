...
interface Author_profileP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP0({ title = 'Add author profile pages', data, onAction }: Author_profileP0Props) {
