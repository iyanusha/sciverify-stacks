...
interface Ethics_reviewP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP0({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP0Props) {
