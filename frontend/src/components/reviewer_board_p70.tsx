...
interface Reviewer_boardP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP70({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP70Props) {
