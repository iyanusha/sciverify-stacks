...
interface Reviewer_boardP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP0({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP0Props) {
