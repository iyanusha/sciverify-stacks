...
interface Metrics_dashP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP70({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP70Props) {
