...
interface Lab_notebookP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP21({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP21Props) {
