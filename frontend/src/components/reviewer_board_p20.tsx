...
interface Reviewer_boardP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP20({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP20Props) {
