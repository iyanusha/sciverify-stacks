...
interface Author_profileP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP1({ title = 'Add author profile pages', data, onAction }: Author_profileP1Props) {
