...
interface Paper_viewerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP10({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP10Props) {
