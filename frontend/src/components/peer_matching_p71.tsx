...
interface Peer_matchingP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Peer_matchingP71({ title = 'Add peer reviewer matching', data, onAction }: Peer_matchingP71Props) {
