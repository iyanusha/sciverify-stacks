...
interface Reviewer_boardP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP1({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP1Props) {
