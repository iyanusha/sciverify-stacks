...
interface Lab_notebookP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP20({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP20Props) {
