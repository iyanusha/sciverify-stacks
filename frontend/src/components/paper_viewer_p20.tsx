...
interface Paper_viewerP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP20({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP20Props) {
