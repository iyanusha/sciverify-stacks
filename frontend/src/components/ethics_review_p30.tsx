...
interface Ethics_reviewP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP30({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP30Props) {
