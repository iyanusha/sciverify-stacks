...
interface Peer_matchingP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Peer_matchingP70({ title = 'Add peer reviewer matching', data, onAction }: Peer_matchingP70Props) {
