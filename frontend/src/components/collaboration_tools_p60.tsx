...
interface Collaboration_toolsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Collaboration_toolsP60({ title = 'Add collaboration tools', data, onAction }: Collaboration_toolsP60Props) {
