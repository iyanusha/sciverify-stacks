...
interface Impact_metricsP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP50({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP50Props) {
