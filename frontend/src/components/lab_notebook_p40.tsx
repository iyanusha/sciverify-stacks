...
interface Lab_notebookP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP40({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP40Props) {
