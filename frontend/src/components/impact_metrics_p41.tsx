...
interface Impact_metricsP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP41({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP41Props) {
