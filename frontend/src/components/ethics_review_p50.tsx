...
interface Ethics_reviewP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP50({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP50Props) {
