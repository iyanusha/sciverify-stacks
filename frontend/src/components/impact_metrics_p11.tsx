...
interface Impact_metricsP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP11({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP11Props) {
