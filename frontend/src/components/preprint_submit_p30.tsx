...
interface Preprint_submitP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP30({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP30Props) {
