...
interface Dataset_viewerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP10({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP10Props) {
