...
interface Org_settingsP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP61({ title = 'Add organization settings', data, onAction }: Org_settingsP61Props) {
