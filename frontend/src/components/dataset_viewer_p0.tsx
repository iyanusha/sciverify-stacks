...
interface Dataset_viewerP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP0({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP0Props) {
