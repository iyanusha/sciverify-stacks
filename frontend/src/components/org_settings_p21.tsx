...
interface Org_settingsP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP21({ title = 'Add organization settings', data, onAction }: Org_settingsP21Props) {
