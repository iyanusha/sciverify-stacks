...
interface Method_registryP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP51({ title = 'Add method registry system', data, onAction }: Method_registryP51Props) {
