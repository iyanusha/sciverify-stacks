...
interface Conf_calendarP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP10({ title = 'Add conference calendar', data, onAction }: Conf_calendarP10Props) {
