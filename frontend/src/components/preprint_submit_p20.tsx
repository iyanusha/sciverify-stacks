...
interface Preprint_submitP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP20({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP20Props) {
