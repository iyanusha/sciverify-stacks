...
interface Grant_proposalsP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP30({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP30Props) {
