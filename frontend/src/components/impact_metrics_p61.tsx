...
interface Impact_metricsP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP61({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP61Props) {
