...
interface Preprint_submitP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP11({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP11Props) {
