...
interface Preprint_submitP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP71({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP71Props) {
