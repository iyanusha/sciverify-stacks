...
interface Ethics_reviewP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP71({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP71Props) {
