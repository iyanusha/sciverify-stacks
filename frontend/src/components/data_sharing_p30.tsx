...
interface Data_sharingP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP30({ title = 'Add data sharing portal', data, onAction }: Data_sharingP30Props) {
