...
interface Ethics_reviewP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP41({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP41Props) {
