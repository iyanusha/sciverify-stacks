...
interface Lab_notebookP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP0({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP0Props) {
