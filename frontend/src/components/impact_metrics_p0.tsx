...
interface Impact_metricsP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP0({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP0Props) {
