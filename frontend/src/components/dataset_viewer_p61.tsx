...
interface Dataset_viewerP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Dataset_viewerP61({ title = 'Add dataset viewer interface', data, onAction }: Dataset_viewerP61Props) {
