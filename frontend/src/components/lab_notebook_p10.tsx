...
interface Lab_notebookP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP10({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP10Props) {
