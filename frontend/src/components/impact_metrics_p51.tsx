...
interface Impact_metricsP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP51({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP51Props) {
