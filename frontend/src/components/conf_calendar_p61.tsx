...
interface Conf_calendarP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP61({ title = 'Add conference calendar', data, onAction }: Conf_calendarP61Props) {
