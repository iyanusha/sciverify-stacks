...
interface Grant_proposalsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP60({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP60Props) {
