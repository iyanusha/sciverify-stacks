...
interface Impact_metricsP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP70({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP70Props) {
