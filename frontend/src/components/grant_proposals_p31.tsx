...
interface Grant_proposalsP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP31({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP31Props) {
