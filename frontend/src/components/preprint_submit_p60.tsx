...
interface Preprint_submitP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP60({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP60Props) {
