...
interface Research_feedP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP60({ title = 'Add research activity feed', data, onAction }: Research_feedP60Props) {
