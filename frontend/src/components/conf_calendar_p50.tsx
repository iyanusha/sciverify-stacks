...
interface Conf_calendarP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP50({ title = 'Add conference calendar', data, onAction }: Conf_calendarP50Props) {
