...
interface Research_feedP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP31({ title = 'Add research activity feed', data, onAction }: Research_feedP31Props) {
