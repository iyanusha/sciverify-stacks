...
interface Org_settingsP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP0({ title = 'Add organization settings', data, onAction }: Org_settingsP0Props) {
