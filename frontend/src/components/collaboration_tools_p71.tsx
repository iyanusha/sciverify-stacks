...
interface Collaboration_toolsP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Collaboration_toolsP71({ title = 'Add collaboration tools', data, onAction }: Collaboration_toolsP71Props) {
