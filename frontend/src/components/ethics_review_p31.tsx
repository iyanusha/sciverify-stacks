...
interface Ethics_reviewP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP31({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP31Props) {
