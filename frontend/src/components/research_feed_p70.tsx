...
interface Research_feedP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP70({ title = 'Add research activity feed', data, onAction }: Research_feedP70Props) {
