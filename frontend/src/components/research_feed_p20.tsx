...
interface Research_feedP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP20({ title = 'Add research activity feed', data, onAction }: Research_feedP20Props) {
