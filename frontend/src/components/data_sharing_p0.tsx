...
interface Data_sharingP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP0({ title = 'Add data sharing portal', data, onAction }: Data_sharingP0Props) {
