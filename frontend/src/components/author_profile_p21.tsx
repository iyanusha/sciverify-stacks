...
interface Author_profileP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP21({ title = 'Add author profile pages', data, onAction }: Author_profileP21Props) {
