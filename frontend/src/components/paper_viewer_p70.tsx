...
interface Paper_viewerP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP70({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP70Props) {
