...
interface Method_registryP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP11({ title = 'Add method registry system', data, onAction }: Method_registryP11Props) {
