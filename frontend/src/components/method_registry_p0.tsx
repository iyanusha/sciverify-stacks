...
interface Method_registryP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP0({ title = 'Add method registry system', data, onAction }: Method_registryP0Props) {
