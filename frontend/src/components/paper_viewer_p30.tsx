...
interface Paper_viewerP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP30({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP30Props) {
