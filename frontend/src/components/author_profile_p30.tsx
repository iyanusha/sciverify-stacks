...
interface Author_profileP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP30({ title = 'Add author profile pages', data, onAction }: Author_profileP30Props) {
