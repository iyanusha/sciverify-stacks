...
interface Conf_calendarP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP70({ title = 'Add conference calendar', data, onAction }: Conf_calendarP70Props) {
