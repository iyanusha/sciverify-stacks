...
interface Data_sharingP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP60({ title = 'Add data sharing portal', data, onAction }: Data_sharingP60Props) {
