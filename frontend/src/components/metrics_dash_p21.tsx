...
interface Metrics_dashP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP21({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP21Props) {
