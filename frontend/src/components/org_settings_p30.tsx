...
interface Org_settingsP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP30({ title = 'Add organization settings', data, onAction }: Org_settingsP30Props) {
