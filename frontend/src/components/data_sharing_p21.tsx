...
interface Data_sharingP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP21({ title = 'Add data sharing portal', data, onAction }: Data_sharingP21Props) {
