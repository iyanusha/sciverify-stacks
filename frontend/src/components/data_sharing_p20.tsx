...
interface Data_sharingP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP20({ title = 'Add data sharing portal', data, onAction }: Data_sharingP20Props) {
