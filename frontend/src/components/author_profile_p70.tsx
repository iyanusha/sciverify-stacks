...
interface Author_profileP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP70({ title = 'Add author profile pages', data, onAction }: Author_profileP70Props) {
