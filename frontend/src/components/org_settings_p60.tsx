...
interface Org_settingsP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP60({ title = 'Add organization settings', data, onAction }: Org_settingsP60Props) {
