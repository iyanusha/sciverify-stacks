...
interface Data_sharingP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP31({ title = 'Add data sharing portal', data, onAction }: Data_sharingP31Props) {
