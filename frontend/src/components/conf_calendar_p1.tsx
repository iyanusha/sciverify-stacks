...
interface Conf_calendarP1Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP1({ title = 'Add conference calendar', data, onAction }: Conf_calendarP1Props) {
