...
interface Org_settingsP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP70({ title = 'Add organization settings', data, onAction }: Org_settingsP70Props) {
