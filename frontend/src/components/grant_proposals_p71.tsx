...
interface Grant_proposalsP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Grant_proposalsP71({ title = 'Add grant proposal tracker', data, onAction }: Grant_proposalsP71Props) {
