...
interface Lab_notebookP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP30({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP30Props) {
