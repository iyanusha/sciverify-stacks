...
interface Ethics_reviewP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP61({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP61Props) {
