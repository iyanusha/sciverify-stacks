...
interface Preprint_submitP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP61({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP61Props) {
