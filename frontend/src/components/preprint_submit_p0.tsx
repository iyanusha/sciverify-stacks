...
interface Preprint_submitP0Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP0({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP0Props) {
