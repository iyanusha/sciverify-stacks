...
interface Metrics_dashP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Metrics_dashP10({ title = 'Add metrics dashboard', data, onAction }: Metrics_dashP10Props) {
