...
interface Method_registryP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP20({ title = 'Add method registry system', data, onAction }: Method_registryP20Props) {
