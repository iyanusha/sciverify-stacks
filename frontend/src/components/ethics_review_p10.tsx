...
interface Ethics_reviewP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP10({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP10Props) {
