...
interface Data_sharingP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Data_sharingP51({ title = 'Add data sharing portal', data, onAction }: Data_sharingP51Props) {
