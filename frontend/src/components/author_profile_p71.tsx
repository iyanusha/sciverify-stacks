...
interface Author_profileP71Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Author_profileP71({ title = 'Add author profile pages', data, onAction }: Author_profileP71Props) {
