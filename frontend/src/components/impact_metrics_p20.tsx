...
interface Impact_metricsP20Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP20({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP20Props) {
