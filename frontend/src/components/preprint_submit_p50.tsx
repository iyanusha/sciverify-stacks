...
interface Preprint_submitP50Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP50({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP50Props) {
