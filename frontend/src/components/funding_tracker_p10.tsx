...
interface Funding_trackerP10Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Funding_trackerP10({ title = 'Add funding tracker dashboard', data, onAction }: Funding_trackerP10Props) {
