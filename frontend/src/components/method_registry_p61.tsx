...
interface Method_registryP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Method_registryP61({ title = 'Add method registry system', data, onAction }: Method_registryP61Props) {
