...
interface Conf_calendarP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Conf_calendarP60({ title = 'Add conference calendar', data, onAction }: Conf_calendarP60Props) {
