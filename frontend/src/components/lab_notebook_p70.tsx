...
interface Lab_notebookP70Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP70({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP70Props) {
