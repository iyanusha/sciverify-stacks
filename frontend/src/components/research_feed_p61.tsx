...
interface Research_feedP61Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP61({ title = 'Add research activity feed', data, onAction }: Research_feedP61Props) {
