...
interface Preprint_submitP40Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Preprint_submitP40({ title = 'Add preprint submission form', data, onAction }: Preprint_submitP40Props) {
