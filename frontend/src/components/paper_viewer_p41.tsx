...
interface Paper_viewerP41Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Paper_viewerP41({ title = 'Add paper viewer component', data, onAction }: Paper_viewerP41Props) {
