...
interface Impact_metricsP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Impact_metricsP21({ title = 'Add research impact metrics', data, onAction }: Impact_metricsP21Props) {
