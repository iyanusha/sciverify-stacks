...
interface Reviewer_boardP51Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Reviewer_boardP51({ title = 'Add reviewer board panel', data, onAction }: Reviewer_boardP51Props) {
