...
interface Ethics_reviewP11Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Ethics_reviewP11({ title = 'Add ethics review workflow', data, onAction }: Ethics_reviewP11Props) {
