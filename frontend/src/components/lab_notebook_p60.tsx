...
interface Lab_notebookP60Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Lab_notebookP60({ title = 'Add lab notebook interface', data, onAction }: Lab_notebookP60Props) {
