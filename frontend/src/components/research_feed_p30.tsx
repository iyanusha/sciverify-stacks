...
interface Research_feedP30Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP30({ title = 'Add research activity feed', data, onAction }: Research_feedP30Props) {
