...
interface Research_feedP21Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Research_feedP21({ title = 'Add research activity feed', data, onAction }: Research_feedP21Props) {
