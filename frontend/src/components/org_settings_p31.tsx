...
interface Org_settingsP31Props { title?: string; data?: Record<string, number>; onAction?: () => void; }
export function Org_settingsP31({ title = 'Add organization settings', data, onAction }: Org_settingsP31Props) {
