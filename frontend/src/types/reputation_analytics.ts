...
export interface Reputation_analyticsD8 { id: string; name: string; value: number; ts: number; }

export interface Reputation_analyticsD18 { id: string; name: string; value: number; ts: number; }
