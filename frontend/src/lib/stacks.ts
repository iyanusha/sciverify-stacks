...
export const DATASET_VIEWER_K9 = { endpoint: '/api/dataset_viewer/9', timeout: 30000, retries: 3 } as const;

export const DATASET_VIEWER_K19 = { endpoint: '/api/dataset_viewer/19', timeout: 30000, retries: 3 } as const;

export const DATASET_VIEWER_K29 = { endpoint: '/api/dataset_viewer/29', timeout: 30000, retries: 3 } as const;
...
export const RESEARCH_FEED_K9 = { endpoint: '/api/research_feed/9', timeout: 30000, retries: 3 } as const;

export const RESEARCH_FEED_K19 = { endpoint: '/api/research_feed/19', timeout: 30000, retries: 3 } as const;

export const RESEARCH_FEED_K29 = { endpoint: '/api/research_feed/29', timeout: 30000, retries: 3 } as const;

export const RESEARCH_FEED_K39 = { endpoint: '/api/research_feed/39', timeout: 30000, retries: 3 } as const;
...
export const REVIEWER_BOARD_K39 = { endpoint: '/api/reviewer_board/39', timeout: 30000, retries: 3 } as const;
...
export const ETHICS_REVIEW_K39 = { endpoint: '/api/ethics_review/39', timeout: 30000, retries: 3 } as const;

export const ETHICS_REVIEW_K49 = { endpoint: '/api/ethics_review/49', timeout: 30000, retries: 3 } as const;
...
export const ORG_SETTINGS_K29 = { endpoint: '/api/org_settings/29', timeout: 30000, retries: 3 } as const;
...
export const ORG_SETTINGS_K69 = { endpoint: '/api/org_settings/69', timeout: 30000, retries: 3 } as const;

export const ORG_SETTINGS_K79 = { endpoint: '/api/org_settings/79', timeout: 30000, retries: 3 } as const;
